...
from entities.train_params import TrainingParams, TrainingPipelineParams


def define_model(train_params: TrainingParams, pretrained_model_path: str):
...
def train_model(model, train_params: TrainingParams):
    if train_params.model_type == "yolov8":
        model.train()
